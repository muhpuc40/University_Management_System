        ...
        <div id="content">
          ...
          <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">All Teachers List</h1>
              <ol class="breadcrumb">
                    ...
                    <?php 
                        ...
                        while($r = mysqli_fetch_array($q)){ ?>
                            <tr>
                                ...
                                <td>
                                <a href="edit_teacher.php?Tid=<?php echo $r['id'] ?>" class="btn btn-secondary">Edit</a>
                                </td>
                                <td>
