...
<html lang="en">
  <head>
    ...
    <title>CSE- Create Teacher</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Provide Teacher Information </h6>
                        </div>
                        <div class="card-body">
                            <form method="post">
                                ...
                                <input type="email" class="form-control" aria-describedby="emailHelp"
                                    placeholder="Enter email"  name="email" id="email" required onkeyup="checkEmail()">
