<?php
   ...
   if($_SESSION['user'] != 'admin'){
    ...
    $t_id = $_REQUEST['Tid'];
    $t = "Select * from teacher_login where id=".$t_id;
        ...
        <div id="content">
          ...
          <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Edit Teacher Information</h1>
              <ol class="breadcrumb">
...
<?php 
    if(isset($_POST['submitBtn'])){
        ...
        $s = "UPDATE teacher_login  SET email='".$s_email."',  password='".$s_pwd."' WHERE id = $r[id]";
