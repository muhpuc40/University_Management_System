                ...
                <div class="col-lg-6">
                    <!-- Form Basic -->
                          ...
                          <?php
                              ...
                              $x = "SELECT name FROM teacher_image WHERE user_id= $Teacher_id ORDER BY id DESC LIMIT 1";
    ...
    <script>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    echo $final_name;
                    $query = "INSERT INTO teacher_image(user_id,name) VALUES ('$Teacher_id' ,'$final_name')";
...
<?php 
    if(isset($_POST['submitBtn'])){
      ...
      $str = "UPDATE teacher_login SET email='".$teacher_email."',password='".$teacher_password."'WHERE id='$Teacher_id'";
